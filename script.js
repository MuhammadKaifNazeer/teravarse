            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                ...
                <div class="d-flex">
                  ...
                  <i class="fa-solid fa-trash" style="cursor: pointer;" onclick="confirmDelete(${todo.id}, '${todo.title}')"></i>
                </div>
              </div>
...
function confirmDelete(todoId, todoTitle) {
  document.getElementById('confirmDeleteText').innerText = `Do you want to delete '${todoTitle}'?`;

  $('#confirmDeleteModal').data('todo-id', todoId);

  $('#confirmDeleteModal').modal('show');
}

function deleteConfirmed() {
  const todoId = $('#confirmDeleteModal').data('todo-id');
